          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="relative">
              ...
              <div className={`absolute -bottom-6 ${language === 'ar' ? '-left-6' : '-right-6'} bg-brandNavy px-10 py-6 rounded-md shadow-xl hidden md:block border-b-4 border-primary`}>
                <p className="text-primary text-4xl font-display font-extrabold leading-tight">2025</p>
                <p className="text-white text-[10px] font-bold uppercase tracking-[0.2em]">{t('Established')}</p>
              </div>
            </div>
            <div>
